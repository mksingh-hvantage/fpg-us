...
export default function App() {
  ...
  <script type="application/ld+json">
    {`{
      ...
      <section className="relative bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 py-20 overflow-hidden">
  ...
  <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <h1 className="text-5xl font-extrabold text-white mb-6 leading-tight">
      Start a C Corporation Online for Free{" "}
      <span className="text-cyan-500">(+ State Filing Fees)</span>
    </h1>

    <p className="text-lg text-gray-300 mb-6">
      Form your C Corporation quickly and affordably with our professional
      business incorporation service. We handle state registration, corporate
      bylaws, EIN assistance, and compliance filings — making it simple to
      incorporate your business with transparent pricing and no hidden fees.
    </p>
    ...
    <button
      ...
      className="inline-block bg-cyan-600 text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-cyan-700 transition-all shadow-xl hover:shadow-cyan-500/30"
    >
      Start Your C Corporation Today
    </button>

    <p className="text-sm text-gray-400 mt-4">
      Fast online C Corp filing • Trusted by entrepreneurs nationwide
    </p>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Simplify Your C Corporation Formation
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-5 p-6 border border-gray-200 rounded-xl hover:shadow-lg transition">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">
                  Complex Incorporation Requirements
                </h3>
            ...
            <div className="flex gap-3 p-6 border border-gray-200 rounded-xl hover:shadow-lg transition">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">
                  Faster and More Affordable C Corp Filing
                </h3>
    ...
    >
      ...
      <section className="py-20 bg-gradient-to-br from-cyan-50 to-yellow-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-5xl font-extrabold text-gray-900 mb-16 text-center">
            Step-by-Step Guide to Forming a C Corporation Online
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Determine If a C Corporation Is Right for Your Business
              </h3>
            ...
            <div className="bg-white rounded-xl p-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Select Your C Corporation Formation Package
              </h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-xl p-8">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                We File Your C Corp & Handle Compliance
              </h3>
              <p className="text-gray-600 mb-6">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-5xl font-extrabold text-gray-900 mb-4 text-center">
            What Happens After You File Your C Corporation?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <div className="bg-blue-100/50 rounded-xl p-8 mb-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Immediate Steps (Day 1)</h3>
              ...
              <div className="bg-blue-100/50 rounded-xl p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Processing Phase (Days 2-5)</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" />
            ...
            <div>
              <div className="bg-blue-100/50 rounded-xl p-8 mb-6">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Approval & Launch (Days 5-10)</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" />
              ...
              <div className="bg-blue-100/50 rounded-xl p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-4">Post-Formation Support</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-5 h-5 text-cyan-600 flex-shrink-0 mt-0.5" />
      ...
      <section className="py-20 bg-yellow-100/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-5xl font-extrabold text-gray-900 mb-4">Loved by 500+</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-5xl font-extrabold text-gray-900 text-center mb-16">Common Questions About Starting a C-Corporation</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-cyan-600 to-cyan-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-5xl font-extrabold mb-6">Ready to Start Your C-Corporation Journey?</h2>
