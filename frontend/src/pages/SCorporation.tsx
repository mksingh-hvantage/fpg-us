...
<div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
               ...
               <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6 leading-base">
                  Start an S Corporation for $0 + <span className='text-cyan-500'>State Filing Fees</span>
               </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
              Start an S Corporation Online | Fast <span className='text-cyan-600'>S Corp Formation Services</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Form your S Corporation online with IRS Form 2553 filing, state registration, registered agent service, and compliance support. Save taxes and grow your business fast.
            </p>
         </div>
         <div className="grid md:grid-cols-2 gap-12 items-center">
   ...
   <section className="py-20 bg-cyan-100/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
              Why Choose The Future Perfect Global for <span className='block text-cyan-600'>S Corporation Formation Services?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-5xl mx-auto">
              Get affordable S Corporation formation, IRS Form 2553 filing, registered agent service, and compliance support. Trusted by small business owners for fast, reliable S Corp setup.
            </p>
         </div>
   ...
   <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
               How to Start an S Corporation Online in <span className='block text-cyan-600'>3 Easy Steps</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
   ...
   <section className="py-20 bg-cyan-100/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
               What Happens After You Start Your <span className='block text-cyan-600'>S Corporation Formation?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
   ...
   <section className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">
               Common Questions About <span className='block text-cyan-600'>Starting an S Corporation</span>
            </h2>
   ...
   <section className="py-20 bg-gradient-to-br from-cyan-500 to-cyan-600 text-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
         <div className="mb-8">
            ...
            <h2 className="text-4xl md:text-5xl leading-xl font-extrabold mb-4">
         ...
         <button onClick={() => { setSelectedBusinessType(""); setIsModalOpen(true); }} className="px-8 py-4 bg-white text-cyan-600 rounded-full text-lg font-semibold hover:bg-gray-50 transition-all shadow-lg hover:shadow-xl">
         Join Today
         </button>
      </div>
   </section>
