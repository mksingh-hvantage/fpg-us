...
export default function VirginiaEntitySearch() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
  <title>
    Virginia Entity Search – Check Business Name & Company Records | The Future Perfect Global
  </title>

  <meta
    name="description"
    content="Perform a Virginia entity search to check business name availability, company status, and registration details. The Future Perfect Global helps you search and register businesses in Virginia."
  />

  {/* Canonical */}
  <link
    rel="canonical"
    href="https://us.thefutureperfectglobal.com/virginia-entity-search"
  />

  {/* Keywords */}
  <meta
    name="keywords"
    content="virginia entity search, virginia business search, virginia company lookup, virginia llc search, check business name virginia, virginia business records, virginia sos entity search"
  />
  ...
  <meta
    property="og:title"
    content="Virginia Entity Search – Check Business Name & Records"
  />
  <meta
    property="og:description"
    content="Search Virginia business entities to verify company names, LLCs, corporations, and registration status with expert assistance."
  />
  <meta
    property="og:url"
    content="https://us.thefutureperfectglobal.com/virginia-entity-search"
  />
  <meta
  ...
  <meta
    ...
    content="Virginia Entity Search – The Future Perfect Global"
  />
  ...
  <meta
    name="twitter:title"
    content="Virginia Entity Search – Business Name Lookup"
  />
  <meta
    name="twitter:description"
    content="Check business name availability and company details using Virginia entity search tools with guidance from The Future Perfect Global."
  />
  <meta
    name="twitter:image"
    content="https://thefutureperfectglobal.ae/uploads/images/logo1.webp"
  ...
  <script type="application/ld+json">
    {`{
      ...
      "@type": "WebPage",
      "name": "Virginia Entity Search",
      "url": "https://us.thefutureperfectglobal.com/virginia-entity-search",
      "description": "Virginia entity search page to check business name availability, company status, and registration records for LLCs and corporations.",
      "publisher": {
        "@type": "Organization",
  ...
  <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
    <div className="text-center mb-12">
      <h1 className="text-5xl lg:text-6xl font-extrabold text-white mb-6">
        Find Your Perfect Virginia Business Name
      </h1>
      <p className="text-xl text-slate-200 max-w-2xl mx-auto">
        Check if your LLC or corporation name is available in Virginia's business
    ...
    <SearchBar />
      ...
      <section className="py-16 bg-cyan-100/50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-5xl font-extrabold text-gray-900 mb-12 text-center">Virginia Naming Requirements</h2>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
      ...
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm h-full">
        ...
        <p className="text-gray-700 mb-6">
          These words cannot be used in your Virginia business name:
        </p>
      ...
      {/* About Virginia Section */}
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm h-full">
        <h2 className="text-3xl font-extrabold text-gray-900 mb-6">
          Why Choose Virginia for Your Business?
        </h2>

        <p className="text-gray-700 leading-relaxed mb-4">
          Virginia is a global hub for finance, technology, and innovation. From
