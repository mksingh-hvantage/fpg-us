...
export default function TexasEntitySearch() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
  <title>
    Texas Entity Search – Check Business Name & Company Records | The Future Perfect Global
  </title>

  <meta
    name="description"
    content="Use the Texas entity search to check business name availability, company status, and registration details. The Future Perfect Global helps you search and register businesses in Texas."
  />

  {/* Canonical */}
  <link
    rel="canonical"
    href="https://us.thefutureperfectglobal.com/texas-entity-search"
  />

  {/* Keywords */}
  <meta
    name="keywords"
    content="texas entity search, texas business search, texas llc search, texas company lookup, check business name texas, texas sos entity search, texas business records"
  />
  ...
  <meta
    property="og:title"
    content="Texas Entity Search – Check Business Name & Records"
  />
  <meta
    property="og:description"
    content="Search Texas business entities to verify company names, LLCs, corporations, and registration status with expert assistance."
  />
  <meta
    property="og:url"
    content="https://us.thefutureperfectglobal.com/texas-entity-search"
  />
  <meta
  ...
  <meta
    ...
    content="Texas Entity Search – The Future Perfect Global"
  />
  ...
  <meta
    name="twitter:title"
    content="Texas Entity Search – Business Name Lookup"
  />
  <meta
    name="twitter:description"
    content="Check business name availability and company details using Texas entity search tools with guidance from The Future Perfect Global."
  />
  <meta
    name="twitter:image"
    content="https://thefutureperfectglobal.ae/uploads/images/logo1.webp"
  ...
  <script type="application/ld+json">
    {`{
      ...
      "@type": "WebPage",
      "name": "Texas Entity Search",
      "url": "https://us.thefutureperfectglobal.com/texas-entity-search",
      "description": "Texas entity search page to check business name availability, company status, and registration records for LLCs and corporations.",
      "publisher": {
        "@type": "Organization",
  ...
  <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
    <div className="text-center mb-12">
      <h1 className="text-5xl lg:text-6xl font-extrabold text-white mb-6">
        Find Your Perfect Texas Business Name
      </h1>
      <p className="text-xl text-slate-200 max-w-2xl mx-auto">
        Check if your LLC or corporation name is available in Texas's business
    ...
    <SearchBar />
      ...
      <section className="py-16 bg-cyan-100/50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-5xl font-extrabold text-gray-900 mb-12 text-center">Texas Naming Requirements</h2>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
      ...
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm h-full">
        ...
        <p className="text-gray-700 mb-6">
          These words cannot be used in your Texas business name:
        </p>
      ...
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm h-full">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Texas is a global hub for finance, technology, and innovation. From
