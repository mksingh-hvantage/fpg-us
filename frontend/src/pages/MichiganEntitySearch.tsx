...
export default function MichiganEntitySearch() {
  ...
  <div className="relative max-w-6xl mx-auto px-6 lg:px-8">
    <div className="text-center mb-12">
      <h1 className="text-5xl lg:text-6xl font-extrabold text-white mb-6">
        Find Your Perfect Michigan Business Name
      </h1>
      <p className="text-xl text-slate-200 max-w-2xl mx-auto">
        Check if your LLC or corporation name is available in Michigan's business
    ...
    <SearchBar />
      ...
      <section className="py-16 bg-cyan-100/50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-5xl font-extrabold text-gray-900 mb-12 text-center">Michigan Naming Requirements</h2>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
      ...
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm h-full">
        ...
        <p className="text-gray-700 mb-6">
          These words cannot be used in your Michigan business name:
        </p>
      ...
      {/* About Michigan Section */}
      <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm h-full">
        <h2 className="text-3xl font-extrabold text-gray-900 mb-6">
          Why Choose Michigan for Your Business?
        </h2>

        <p className="text-gray-700 leading-relaxed mb-4">
          Michigan is a global hub for finance, technology, and innovation. From
